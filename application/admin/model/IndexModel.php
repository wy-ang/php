...
class IndexModel extends Model
{
    ...
    public function articleInfo(){
        ...
        $article = Db::name('article')->where('authorId', $id)->field('FROM_UNIXTIME(create_time) as create_time,FROM_UNIXTIME(update_time) as update_time,author,authorId,content,id')->select();
