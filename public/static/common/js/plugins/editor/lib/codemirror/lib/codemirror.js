...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    d.selectionDiv = elt("div", null, null, "position: relative; z-article: 1");
    ...
    // Work around IE7 z-article bug (not perfect, hence IE7 not really being supported)
  ...
  TextareaInput.prototype = copyObj({
    ...
    onContextMenu: function(e) {
      ...
      te.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) +
        "px; left: " + (e.clientX - 5) + "px; z-article: 1000; background: " +
  ...
  // text, direction 1 means to move towards the next article in the
